...
Methodology:
 	Generates a SuDoKu grid (SDKGrid) comprised of individual cell (SDKCells) that contain the puzzle information. When solving, the
	app considers the following approaches:

  Method #1: Reduce and assess individual cell possibilities
  ...
  Method #2: Assess row, column and box possibilities
	check_neighbours()
  ...
  TO-DO
    - Currently solves easy, medium and some hard puzzles. Does not solve "evil" or "diabolical" puzzles. Need to implement
		advanced solving logic.
