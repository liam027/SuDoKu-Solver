...
Methodology:
  ...
  Method #1: Reduce and assess individual cell possibilities
    ...
    Each cell is aware of all values it could possibly be (cell.possiblities, 1 through 9 to start). If a possible value is present in another cell in its row, column or box, that possibility is removed. Once a cell has only once possibility, it can be solved.
